# Awesome Material Design with stars
...
* [material-design-icons](https://github.com/google/material-design-icons) ⭐ 53,769 | 🐛 417 | 📅 2026-08-14 — Material Design icons by Google.
...
* [sass-material-colors](https://github.com/minusfive/sass-material-colors) ⚠️ Archived — An easy way to use Google's Material Design colors in your Sass/Scss project.
* [material-design-fonticons](https://github.com/designjockey/material-design-fonticons) ⭐ 71 | 🐛 2 | 🌐 CSS | 📅 2017-04-18 — Material Design Fonticons is a font converted version of the Google Material Design Icon set.
* [Google-Material-Design-Font-Icon](https://github.com/Seb-L/Google-Material-Design-Font-Icon) ⚠️ Archived — Font Icon based on Google Material Design Icon set.
...
* [SVG-Morpheus](https://github.com/alexk111/SVG-Morpheus) ⭐ 2,696 | 🐛 11 | 🌐 JavaScript | 📅 2017-07-21 — JavaScript library enabling SVG icons to morph from one to the other. It implements Material Design's Delightful Details transitions.
...
* [md-timepicker](https://github.com/dotlouis/md-timepicker) ⚠️ Archived — A Polymer Timepicker element in Material Design.
* [Material-Design-ColorPicker](https://github.com/Fraina/Material-Design-ColorPicker) ⭐ 11 | 🐛 0 | 🌐 CSS | 📅 2018-04-12 — A Material Design Color Picker.
...
* [material-ui](https://github.com/callemall/material-ui) ⭐ 98,762 | 🐛 1,491 | 🌐 JavaScript | 📅 2026-08-13 — A CSS Framework and a Set of React Components that Implement Google's Material Design.
* [materialize](https://github.com/Dogfalo/materialize) ⭐ 38,832 | 🐛 791 | 🌐 JavaScript | 📅 2026-07-31 — Materialize, a CSS Framework based on Material Design.
* [mui](https://github.com/muicss/mui) ⭐ 4,485 | 🐛 77 | 🌐 JavaScript | 📅 2021-08-23 — A lightweight CSS framework that follows Material Design guidelines.
* [material-framework](https://github.com/nt1m/material-framework) ⭐ 382 | 🐛 36 | 🌐 HTML | 📅 2019-12-07 — An easy to use material design based framework.
...
* [material-playground](https://github.com/ebidel/material-playground) ⭐ 256 | 🐛 0 | 🌐 JavaScript | 📅 2021-10-04 — Polymer material design playground.
* [materialBootstrap](https://github.com/throrin19/materialBootstrap) ⭐ 68 | 🐛 0 | 🌐 CSS | 📅 2015-09-16 — Twitter Bootstrap theme for Google material design.
* [bootstrap-material-design](https://github.com/FezVrasta/bootstrap-material-design) ⭐ 25 | 🐛 0 | 🌐 HTML | 📅 2021-05-21 — Material design theme for Bootstrap 3.
* [Tronic247 Material](https://www.tronic247.com/material/) - A material design framework based on jQuery and CSS

# JS

* [material-design-lite](https://github.com/google/material-design-lite/) ⭐ 32,188 | 🐛 431 | 🌐 HTML | 📅 2026-05-03 — Material Design Lite Components in HTML/CSS/JS.
* [Angular](https://github.com/angular/material2) ⭐ 25,036 | 🐛 1,375 | 🌐 TypeScript | 📅 2026-08-12 — Material design for Angular.
...
* [quantum-colors](https://github.com/nkpfstr/quantum-colors) ⭐ 40 | 🐛 0 | 🌐 CSS | 📅 2018-01-29 — Material Design color palette for your Sass projects.
* [quantum-shadows](https://github.com/nkpfstr/quantum-shadows) ⭐ 33 | 🐛 0 | 🌐 CSS | 📅 2017-03-08 — Material Design drop shadows for your Sass projects.
* [google-material-design](https://github.com/axyz/google-material-design) ⭐ 16 | 🐛 2 | 🌐 CSS | 📅 2014-08-04 — Small SASS library inspired by google material design guidelines.

# WordPress

* [materialwp](https://github.com/braginteractive/materialwp) ⭐ 461 | 🐛 26 | 🌐 CSS | 📅 2023-01-10 — Material Design WordPress Theme.
* [MaterialPress](https://github.com/alexpatin/MaterialPress) ⭐ 105 | 🐛 1 | 🌐 JavaScript | 📅 2015-03-14 — MaterialPress is a WordPress theme, influenced heavily by Google's Material Design philosophy.

# WinForms

* [MaterialSkin](https://github.com/IgnaceMaes/MaterialSkin) ⭐ 3,043 | 🐛 149 | 🌐 C# | 📅 2024-07-15 — Theming .NET WinForms, C# or VB.Net, to Google's Material Design Principles.

# XAML

* [MaterialDesignInXamlToolkit](https://github.com/ButchersBoy/MaterialDesignInXamlToolkit) ⭐ 16,234 | 🐛 153 | 🌐 C# | 📅 2026-08-03 — Google's Material Design in XAML & WPF, for C# & VB.Net.

# Other

* [material\_design\_zh](https://github.com/1sters/material_design_zh) ⭐ 3,050 | 🐛 12 | 🌐 CSS | 📅 2019-05-06 — Material Design Collaborative Chinese translation
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,607 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02 list.
